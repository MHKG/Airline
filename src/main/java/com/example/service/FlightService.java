...
public class FlightService {
    ...
    public Flight getByFlightNumber(String flight_number) {
        Query query =
                entityManager
                        .createQuery(environment.getProperty("findByFlightNumber"), Flight.class)
    ...
    public List<Flight> searchFlights(
            String source, String destination, String date_of_journey, int seats_required) {
        Query query =
                entityManager.createQuery(environment.getProperty("findAllFlights"), Flight.class);
    ...
    public boolean bookFlight(String flight_number, int seats_required, Customer[] customers) {
        ...
        if (flight.getAvailable_seats() >= seats_required) {
            ...
            String insertBookingQuery =
                    "INSERT INTO Booking (flight_number, seats_booked, customer_id, booking_date) VALUES (?, ?, ?, CURRENT_TIMESTAMP)";
            ...
            Query decrementSeatQuery =
                    entityManager
                            .createQuery(environment.getProperty("decrementSeat"))
